...
export default mimic(0, "flatten", assertReplace((x = 1) => isPositiveInteger(x), assertIterator(
    async function* recurse(this: AsyncIterator<unknown, unknown, unknown>, _next: AsyncIterator<unknown, unknown, unknown>["next"], depth: number): AsyncGenerator<unknown, void, unknown> {
